...
describe("MultiSig with Cngn", function () {
    ...
    beforeEach(async function () {
        ...
        admin = await upgrades.deployProxy(Admin, [], { initializer: 'initialize', kind: "transparent" });
        ...
        // Deploy the cNGN contract
        CNGN = await ethers.getContractFactory("Cngn2");
        cngn = await upgrades.deployProxy(CNGN, [forwarder.address, admin.address], { initializer: 'initialize', kind: "transparent" });

        // Whitelist Cngn2 as a trusted contract
        await admin.addTrustedContract(cngn.address);
    ...
    describe("Minting and Burning", function () {
        ...
        it("should allow minting of tokens and verify that minter is removed", async function () {
            ...
            console.log("Mint Event=========: ", mintEvent.args);
        ...
        it("should allow burning tokens", async function () {
            ...
            console.log("Burn Event=========: ", burnEvent.args);
            //  Assert the event data
    ...
    describe("Destroy Blacklisted Funds", function () {
        ...
        it("should allow owner to destroy blacklisted user's funds", async function () {
            ...
            await multiSigCall(multiSig, admin.address, addToblacklistData, owner2, 2)
            const balanceAddress1 = await cngn.balanceOf(addr1.address);
            console.log("Current Balance Address 1 to burn: ", balanceAddress1.toString());
