...
pub mod Operations2 {
    ...
    #[abi(embed_v0)]
    impl Operations2Impl of cngn::interface::IOperations::IAdmin<ContractState> {
    ...
    #[abi(embed_v0)]
    impl PauseControlImpl of super::IPauseControl<ContractState> {
...
#[starknet::interface]
pub trait IPauseControl<TContractState> {
