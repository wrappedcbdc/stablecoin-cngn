...
async function main() {
  ...
  console.log("Mint Authority", pdas.mintAuthority.toString())
  try {
    ...
    await createMintAccountWithExtensions(
      ...
      cngnMintKeypair,
      Cngnparams,
      pdas.multisig, //permanent delegate
    ...
    await transferFreezeAuthority(pdas.multisig, cngnMintKeypair.publicKey, payer, connection)
  } catch (error) {
