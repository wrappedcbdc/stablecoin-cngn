...
export const transferMintAuthority = async (mintAuthorityPDA: PublicKey, mintAddress: PublicKey, payer: anchor.web3.Keypair, connection: Connection) => {
   ...
   await verifyMintAuthorities(connection, mintAddress, mintAuthorityPDA);
};
